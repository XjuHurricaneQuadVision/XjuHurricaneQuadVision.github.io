...
{% include button.html text="Follow us" icon="github" link="https://github.com/XjuHurricaneQuadVision" color="#0366d6" %} {% include button.html text="公众号 📱" link="/assets/images/wechat.png" target="_blank" color="#1dd86eff" %} {% include button.html text="小红书官方账号 📕" link="https://www.xiaohongshu.com/user/profile/662e22f9000000000d02752d?xsec_token=ABWWJ0EqSELaIjvtWnRE8evHhyXC1H_xq7TQEuo6zftc4%3D&xsec_source=pc_search" color="#e71717ff" %}
